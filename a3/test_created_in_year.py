...
def test_article_to_wrong_year() -> None:
    """Test created_in_year with an existing article with a wrong year.
    """
    
    actual = arxiv_functions.created_in_year(TEST_ARXIV, '0001', 2026)
    expected = False
    assert actual == expected
    

def test_nonexisting_article() -> None:
    """Test created_in_year with an non-existing article.
    """
    
    actual = arxiv_functions.created_in_year(TEST_ARXIV, '507', 2023)
    expected = False
    assert actual == expected
    

def test_empty_article() -> None:
    """Test created_in_year with an empty article.
    """
    
    actual = arxiv_functions.created_in_year(TEST_ARXIV, '', 2022)
    expected = False
    assert actual == expected
    

def test_negative_year() -> None:
    """Test created_in_year with a negative year.
    """
    
    actual = arxiv_functions.created_in_year(TEST_ARXIV, '42', -2023)
    expected = False
    assert actual == expected
    

def test_year_zero() -> None:
    """Test created_in_year with year 0.
    """
    
    actual = arxiv_functions.created_in_year(TEST_ARXIV, '42', 0)
    expected = False
    assert actual == expected
    

def test_empty_arxiv() -> None:
    """Test created_in_year with an empty arxiv with a given article and 
    a given year.
    """
    
    actual = arxiv_functions.created_in_year(ArxivType({}), '108', 2023)
    expected = False
    assert actual == expected
